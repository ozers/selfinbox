      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <motion.div variants={item} className="lg:col-span-2">
          <div className="mb-3 flex items-center justify-between">
            ...
            {hasDomains && (
              <Link to="/domains" className="text-xs text-muted-foreground hover:text-foreground transition-colors">
                Manage all &rarr;
              </Link>
            )}
          </div>
        ...
        <motion.div variants={item}>
          <div className="mb-3 flex items-center justify-between">
            ...
            {recentEmails.length > 0 && (
              <Link to="/inbox" className="text-xs text-muted-foreground hover:text-foreground transition-colors">
                View all &rarr;
              </Link>
            )}
          </div>
